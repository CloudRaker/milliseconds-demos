/**
 * Seeded fixtures, copied from the Jev experiment (src/data/generate.ts), plus the
 * workbook the sheet opens with. Synthetic: no real people, companies or PII —
 * everything is assembled from fragments with a seeded PRNG, so every visitor sees
 * the same 300 reviews and 150 leads.
 */
