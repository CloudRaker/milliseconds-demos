...
export default function Demo() {
  ...
  return <div className="receipt-demo">
    ...
    <details className="panel"><summary>Workflow notes</summary>
      <p>One <code>extract</code> call reads five fields: merchant, date, total, item name and item price. Line items come back as an array; each property counts once toward the limit, regardless of the number of items. A field the model did not find comes back empty.</p>
