...
import { extractionRequest } from '../demos/receipt-reader/logic.ts';
import { RECEIPT } from '../demos/receipt-reader/receipt.ts';
...
const examples: StockExample[] = [
  { demo: 'receipt-reader', scenario: 'bakery-receipt', route: 'extract', body: extractionRequest(RECEIPT.dataUrl, 'medium') },
];
